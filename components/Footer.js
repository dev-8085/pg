...
const data = {
	contacts: [
		{
			icon: (
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="w-[4rem]">
		...
		{
			icon: (
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="w-[1.5rem]">
	...
	return (
		<>
			<div className="relative">
				...
				<div className="container-fluid bg-dark text-white footer wow fadeIn" data-wow-delay="0.1s">
					<div className="container pb-5">
						<div className="row g-5 pt-5">
								...
								<div className="max-w-sm flex items-center justify-center space-y-3">
									<div className="mt-3">
										...
										<div className="flex rounded-lg shadow-sm h-[3rem]">
											<div className="py-2 bg-white text-gray-600 text-lg px-4 block w-full border-gray-200 shadow-sm rounded-s-lg focus:z-10 disabled:opacity-50 disabled:pointer-events-none">
							...
							<div className="col-md-6 col-lg-3 flex flex-col items-start">
								<h6 className="section-title text-start text-[#FEA116] text-uppercase mb-4">Contact</h6>
								{data.contacts.map((item, index) => (
									<div key={index} className="mb-3 flex flex-row gap-2 items-start">
										{item.icon}
										<p>{item.text}</p>
									</div>
								))}
							...
							<div className="col-lg-5 col-md-12">
								<div className="row gy-5 g-4">
									<div className="col-md-6 flex flex-col items-start">
										<h6 className="section-title text-start text-[#FEA116] text-uppercase mb-4">Company</h6>
										{data.companyLinks.map((link, index) => (
											<Link key={index} href={link.href} className="text-white text-sm flex flex-row no-underline items-center gap-1 hover:animate-pulse">
												<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
									...
									<div className="col-md-6 flex flex-col items-start">
										<h6 className="section-title text-[#FEA116] text-start text-uppercase mb-4">Highlights</h6>
										{data.highlightsLinks.map((highlight, index) => (
											<Link key={index} href="#" className="no-underline flex-row text-white text-sm flex items-center gap-1 hover:animate-pulse">
												<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
													<path d="M13.1717 12.0007L8.22192 7.05093L9.63614 5.63672L16.0001 12.0007L9.63614 18.3646L8.22192 16.9504L13.1717 12.0007Z" />
												</svg>
						...
						<div className="copyright">
							...
							<div className="row py-4">
								<div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
									&copy;
									<Link className="border-bottom no-underline text-white" href="#">
								...
								<div className="col-md-6 text-center text-md-end">
									<div className="footer-menu flex items-center justify-end">
										<Link href="" className="px-3 border-r no-underline text-white">
											Home
										</Link>
										<Link href="" className="px-3 border-r no-underline text-white">
											Cookies
