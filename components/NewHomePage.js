...
const NewHomePage = () => {
	...
	return (
		<div
			// bg-orange-50
			className="section w-full flex gap-3 flex-col lg:flex-row justify-between items-start px-10 py-10 relative "
		>
			...
			<div className="rgtContainer w-full lg:w-[50vw]">
				...
				<ul className="flex flex-col gap-5 lg:w-[40vw]">
					...
					{features.map((feature, index) => (
						<li
							key={index}
							className="border border-black shadow-lg  lg:h-[14rem]  bg-[#fff] hover:bg-[#a5a4a4]  lg:w-[32rem] rounded  text-[#000] hover:text-white p-8 flex items-center justify-between transform transition duration-500 
                                hover:scale-110"
